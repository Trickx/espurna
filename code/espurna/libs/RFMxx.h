...
public:
  ...
  RFMxx(byte mosi=255, byte miso=255, byte sck=255, byte ss=255, byte irq=255, TPinCallback pinFunction = NULL);
  byte ToggleMode;
  ...
  void InitializePCA301();
  void InitializeEC3000();
  void InitializeElero();
  ...
  int GetRSSI(bool doTrigger = false);
...
private:
  ...
  bool m_debug;
  RFMxx::TPinCallback *m_pinCallback;
